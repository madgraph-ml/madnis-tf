...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WW)
      ...
      CALL FFV2_1(W(1,4),W(1,3),GC_100,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,5),W(1,7),W(1,6),GC_11,AMP(1))
      CALL FFV2_2(W(1,5),W(1,3),GC_100,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,8),W(1,4),W(1,6),GC_11,AMP(2))
      CALL FFV1_1(W(1,4),W(1,1),GC_11,ZERO, FK_ZERO,W(1,6))
      CALL FFV1_2(W(1,5),W(1,2),GC_11,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,9),W(1,6),W(1,3),GC_100,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,8),W(1,6),W(1,2),GC_11,AMP(4))
      CALL FFV1_2(W(1,5),W(1,1),GC_11,ZERO, FK_ZERO,W(1,6))
      CALL FFV1_1(W(1,4),W(1,2),GC_11,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,6),W(1,5),W(1,3),GC_100,AMP(5))
