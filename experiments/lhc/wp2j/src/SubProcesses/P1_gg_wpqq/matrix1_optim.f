...
C     
C     Process: g g > w+ d u~ WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     
      ...
      PARAMETER (NWAVEFUNCS=27, NCOLOR=2) 
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
      COMPLEX*16 IMAG1
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL VXXXXX(P(0,1),ZERO,+1,-1*IC(1),W(1,1)) ! count 15
      CALL VXXXXX(P(0,1),ZERO,-1,-1*IC(1),W(1,2)) ! count 15
      CALL VXXXXX(P(0,2),ZERO,+1,-1*IC(2),W(1,3)) ! count 15
      CALL VXXXXX(P(0,2),ZERO,-1,-1*IC(2),W(1,4)) ! count 15
      CALL VXXXXX(P(0,3),MDL_MW,+1,+1*IC(3),W(1,5)) ! count 10
      CALL VXXXXX(P(0,3),MDL_MW, 0,+1*IC(3),W(1,6)) ! count 10
      CALL VXXXXX(P(0,3),MDL_MW,-1,+1*IC(3),W(1,7)) ! count 10
      CALL OXXXXX(P(0,4),ZERO,-1,+1*IC(4),W(1,8)) ! count 13
      CALL IXXXXX(P(0,5),ZERO,+1,-1*IC(5),W(1,9)) ! count 13
      CALL VVV1P0_1(W(1,1),W(1,3),GC_10,ZERO, FK_ZERO,W(1,10)) ! count 6
      CALL VVV1P0_1(W(1,2),W(1,4),GC_10,ZERO, FK_ZERO,W(1,13)) ! count 6
      CALL FFV2_1(W(1,8),W(1,5),GC_100,ZERO, FK_ZERO,W(1,14)) ! count 10
      CALL FFV2_1(W(1,8),W(1,6),GC_100,ZERO, FK_ZERO,W(1,15)) ! count 10
      CALL FFV2_1(W(1,8),W(1,7),GC_100,ZERO, FK_ZERO,W(1,16)) ! count 10
      CALL FFV1P1N_2(W(1,9), W(1,10), GC_11, TMP(1))
      call CombineAmp(3,
     & (/12,11,10/), 
     & (/14,15,16/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_2(W(1,9), W(1,13), GC_11, TMP(1))
      call CombineAmp(3,
     & (/3,2,1/), 
     & (/14,15,16/),
     & TMP, W, AMP(1,1)) ! count 1
      CALL FFV2_2(W(1,9),W(1,5),GC_100,ZERO, FK_ZERO,W(1,17)) ! count 10
      CALL FFV2_2(W(1,9),W(1,6),GC_100,ZERO, FK_ZERO,W(1,18)) ! count 10
      CALL FFV2_2(W(1,9),W(1,7),GC_100,ZERO, FK_ZERO,W(1,19)) ! count 10
      CALL FFV1P1N_1(W(1,8), W(1,10), GC_11, TMP(1))
      call CombineAmp(3,
     & (/12,11,10/), 
     & (/17,18,19/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_1(W(1,8), W(1,13), GC_11, TMP(1))
      call CombineAmp(3,
     & (/3,2,1/), 
     & (/17,18,19/),
     & TMP, W, AMP(1,2)) ! count 1
      CALL FFV1_1(W(1,8),W(1,1),GC_11,ZERO, FK_ZERO,W(1,20)) ! count 12
      CALL FFV1_1(W(1,8),W(1,2),GC_11,ZERO, FK_ZERO,W(1,21)) ! count 12
      CALL FFV1_2(W(1,9),W(1,3),GC_11,ZERO, FK_ZERO,W(1,22)) ! count 12
      CALL FFV1_2(W(1,9),W(1,4),GC_11,ZERO, FK_ZERO,W(1,23)) ! count 12
      CALL FFV2P1N_3(W(1,22), W(1,20), GC_100, TMP(1))
      call CombineAmp(3,
     & (/12,11,10/), 
     & (/5,6,7/),
     & TMP, W, AMP(1,3))
      CALL FFV2P1N_3(W(1,22), W(1,21), GC_100, TMP(1))
      call CombineAmp(3,
     & (/6,5,4/), 
     & (/5,6,7/),
     & TMP, W, AMP(1,3))
      CALL FFV2P1N_3(W(1,23), W(1,20), GC_100, TMP(1))
      call CombineAmp(3,
     & (/9,8,7/), 
     & (/5,6,7/),
     & TMP, W, AMP(1,3))
      CALL FFV2P1N_3(W(1,23), W(1,21), GC_100, TMP(1))
      call CombineAmp(3,
     & (/3,2,1/), 
     & (/5,6,7/),
     ...
     & (/17,18,19/),
     & TMP, W, AMP(1,4))
      CALL FFV1P1N_1(W(1,21), W(1,3), GC_11, TMP(1))
      call CombineAmp(3,
     & (/6,5,4/), 
     & (/17,18,19/),
     & TMP, W, AMP(1,4))
      CALL FFV1P1N_1(W(1,21), W(1,4), GC_11, TMP(1))
      call CombineAmp(3,
     & (/3,2,1/), 
     & (/17,18,19/),
     & TMP, W, AMP(1,4)) ! count 1
      CALL FFV1_2(W(1,9),W(1,1),GC_11,ZERO, FK_ZERO,W(1,24)) ! count 12
      CALL FFV1_2(W(1,9),W(1,2),GC_11,ZERO, FK_ZERO,W(1,25)) ! count 12
      CALL FFV1_1(W(1,8),W(1,3),GC_11,ZERO, FK_ZERO,W(1,26)) ! count 12
      CALL FFV1_1(W(1,8),W(1,4),GC_11,ZERO, FK_ZERO,W(1,27)) ! count 12
      CALL FFV2P1N_3(W(1,24), W(1,26), GC_100, TMP(1))
      call CombineAmp(3,
     & (/12,11,10/), 
     & (/5,6,7/),
     & TMP, W, AMP(1,5))
      CALL FFV2P1N_3(W(1,24), W(1,27), GC_100, TMP(1))
      call CombineAmp(3,
     & (/9,8,7/), 
     & (/5,6,7/),
     & TMP, W, AMP(1,5))
      CALL FFV2P1N_3(W(1,25), W(1,26), GC_100, TMP(1))
      call CombineAmp(3,
     & (/6,5,4/), 
     & (/5,6,7/),
     & TMP, W, AMP(1,5))
      CALL FFV2P1N_3(W(1,25), W(1,27), GC_100, TMP(1))
      call CombineAmp(3,
     & (/3,2,1/), 
     & (/5,6,7/),
     & TMP, W, AMP(1,5)) ! count 1
      CALL FFV1P1N_2(W(1,24), W(1,3), GC_11, TMP(1))
      call CombineAmp(3,
     & (/12,11,10/), 
     & (/14,15,16/),
     & TMP, W, AMP(1,6))
      CALL FFV1P1N_2(W(1,24), W(1,4), GC_11, TMP(1))
      call CombineAmp(3,
     & (/9,8,7/), 
     & (/14,15,16/),
     & TMP, W, AMP(1,6))
      CALL FFV1P1N_2(W(1,25), W(1,3), GC_11, TMP(1))
      call CombineAmp(3,
     & (/6,5,4/), 
     & (/14,15,16/),
     & TMP, W, AMP(1,6))
      CALL FFV1P1N_2(W(1,25), W(1,4), GC_11, TMP(1))
      call CombineAmp(3,
     & (/3,2,1/), 
     & (/14,15,16/),
     & TMP, W, AMP(1,6)) ! count 1
      CALL FFV1P1N_1(W(1,26), W(1,1), GC_11, TMP(1))
      call CombineAmp(3,
     & (/12,11,10/), 
     & (/17,18,19/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_1(W(1,26), W(1,2), GC_11, TMP(1))
      call CombineAmp(3,
     & (/6,5,4/), 
     & (/17,18,19/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_1(W(1,27), W(1,1), GC_11, TMP(1))
      call CombineAmp(3,
     & (/9,8,7/), 
     & (/17,18,19/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_1(W(1,27), W(1,2), GC_11, TMP(1))
      call CombineAmp(3,
     & (/3,2,1/), 
     & (/17,18,19/),
     & TMP, W, AMP(1,7)) ! count 1
      CALL FFV1P1N_2(W(1,22), W(1,1), GC_11, TMP(1))
      call CombineAmp(3,
     & (/12,11,10/), 
     & (/14,15,16/),
     & TMP, W, AMP(1,8))
      CALL FFV1P1N_2(W(1,22), W(1,2), GC_11, TMP(1))
      call CombineAmp(3,
     & (/6,5,4/), 
     & (/14,15,16/),
     & TMP, W, AMP(1,8))
